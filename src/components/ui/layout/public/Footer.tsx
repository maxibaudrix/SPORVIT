        ...
        <div className="grid md:grid-cols-5 gap-8 mb-8">
          ...
          <div>
            ...
            <ul className="space-y-1 text-sm text-slate-400 leading-tight">
              <li><Link href="/comofunciona" className="hover:text-emerald-400 transition-colors">Cómo funciona</Link></li>
              ...
              <li><Link href="/calculators" className="hover:text-emerald-400 transition-colors">Calculadoras</Link></li>
            </ul>
          </div>
          ...
          <div>
            ...
            <ul className="space-y-1 text-sm text-slate-400 leading-tight">
              ...
              <li><Link href="/business" className="hover:text-emerald-400 transition-colors">B2B</Link></li>
              <li><Link href="/professionals" className="hover:text-emerald-400 transition-colors">Profesionales</Link></li>
              <li><Link href="/contact" className="hover:text-emerald-400 transition-colors">Contacto</Link></li>
            </ul>
          </div>
          ...
          <div>
            ...
            <ul className="space-y-1 text-sm text-slate-400 leading-tight">
              <li><Link href="/legal/privacy" className="hover:text-emerald-400 transition-colors">Privacidad</Link></li>
              <li><Link href="/legal/terms" className="hover:text-emerald-400 transition-colors">Términos</Link></li>
              <li><Link href="/legal/cookies" className="hover:text-emerald-400 transition-colors">Cookies</Link></li>
            </ul>
          </div>
        </div>
