...
export const metadata: Metadata = {
  ...
  description: 'Herramientas gratuitas de precisión para optimizar tu rendimiento: FFMI, Macros, VO2 Máx, Zonas de FC y más. Todas 100% gratis.',
  keywords: 'calculadoras fitness, calculadora macros, FFMI, VO2 max, zonas frecuencia cardíaca, calculadora IMC, nutrición deportiva',
  openGraph: {
    title: 'Centro de Calculadoras Fitness - Sporvit',
    description: 'Todas las herramientas que necesitas para optimizar tu entrenamiento y nutrición',
    type: 'website',
    images: ['/og-calculators-hub.jpg'],
  },
};
...
export default function CalculatorsHubPage() {
  ...
  const calculators = [
    ...
    { title: "Zonas de Frecuencia Cardíaca", icon: <Heart />, href: "/calculators/heart-rate-zones", category: "Rendimiento", highlight: true },
  ...
  return (
    <div className="pt-16 pb-16 container mx-auto px-4 sm:px-6 max-w-7xl">
