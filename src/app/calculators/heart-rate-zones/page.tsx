...
import { 
  Heart, Calculator, Info, Share2, Code, Copy, ArrowRight,
  MessageCircle, Send, Mail, Check, ExternalLink, Activity, Zap, AlertCircle
} from 'lucide-react';
...
export const metadata: Metadata = {
  ...
  openGraph: {
    ...
    type: 'website',
    url: 'https://sporvit.com/calculadoras/zonas-frecuencia-cardiaca',
    images: [
      {
        url: '/og-hr-zones.jpg',
        width: 1200,
  ...
  alternates: {
    canonical: 'https://sporvit.com/calculadoras/zonas-frecuencia-cardiaca',
  },
};
...
export default function HRZonesCalculator() {
  ...
  return (
    <div className="min-h-screen bg-slate-950 text-slate-200 font-sans selection:bg-emerald-500/30">
      ...
      <main className="pt-16 pb-16 container mx-auto px-4 sm:px-6 max-w-6xl">
        {/* ============================================
            HEADER
        ============================================ */}
            ...
            <div className={`transition-all duration-700 ${result ? 'opacity-100 scale-100' : 'opacity-40 grayscale pointer-events-none scale-95'}`}>
              <div className="bg-gradient-to-br from-slate-900 to-slate-950 border border-slate-800 rounded-3xl p-6 shadow-2xl">
                ...
                <div className="space-y-3" role="list" aria-label="Zonas de entrenamiento">
                  {result ? result.zones.map((z: Zone, idx: number) => (
                    <div 
                      key={z.name} 
